...
namespace CustomIdentityProviderSample.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> ExternalLoginCallback(string returnUrl = null, string remoteError = null)
        {
            ...
            try
            {
                signInResult = await _signInManager.ExternalLoginSignInAsync(info.LoginProvider, info.ProviderKey, isPersistent: false);
            }            
            catch(Exception ex)
            {
        ...
        public async Task<IActionResult> ExternalLoginConfirmation(ExternalLoginConfirmationViewModel model, string returnUrl = null)
        {
            if (ModelState.IsValid)
            {
                ...
                var user = new ApplicationUser
                {
                    ...
                    Name = info.Principal.Claims.FirstOrDefault(claim => string.Equals(claim.Type, "name", StringComparison.InvariantCultureIgnoreCase))?.Value,
                    Email = model.Email,
